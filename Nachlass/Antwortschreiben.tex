...
\setkomavar{zeichen} {Nachlaßpflegschaft Ernst Felix Rabeler}%    'Ihr Zeichen...'
...
%---------------------------------------------------------------------------
\begin{letter}{Frau Kristine Matschke\\Nachlaßpflegerin\\Gelfertstraße 28\\14195 Berlin}
%---------------------------------------------------------------------------
% Weitere Optionen
\KOMAoptions{%%
}
%---------------------------------------------------------------------------
\setkomavar{subject}{Antwort auf Schreiben vom 22.09.2014}
%---------------------------------------------------------------------------
\opening{Sehr geehrte Frau Matschke,}


vielen Dank, dass Sie mir die Möglichkeit eingeräumt haben, die auf Herrn Ernst Felix Rabeler eingetragenen Domains bei der \textsl{Host Europe GmbH} zu übernehmen. Hieran habe ich jedoch kein Interesse.
