...
%---------------------------------------------------------------------------
\begin{letter}{Gesundheitsamt Berlin Tempelhof-Schöneberg\\z. H. Frau Yadi\\Alarichstraße 12-15\\12105 Berlin}
%---------------------------------------------------------------------------
% Weitere Optionen
\KOMAoptions{%%
}
%---------------------------------------------------------------------------
\setkomavar{subject}{Weiterbewilligung der Einzelfallhilfe}
%---------------------------------------------------------------------------
\opening{Sehr geehrte Frau Yadi,}

hiermit beantrage ich die Weiterbewilligung der Einzelfallhilfe des Sozial-psychiatrischen Dienstes. Diese wird durch Herrn Kai-Uwe Christoph durchgeführt.
