...
\newkomavar*[Geschäftszeichen]{zeichen}
%---------------------------------------------------------------------------
\begin{document}
%---------------------------------------------------------------------------
...
%---------------------------------------------------------------------------
\firsthead{Angebot einer Ratenzahlung}
%---------------------------------------------------------------------------
%\firstfoot{Fußzeile}
%---------------------------------------------------------------------------
...
\setkomavar{zeichen} {100.007.110-1/02/ÜS}%    'Geschäftszeichen...'
...
%---------------------------------------------------------------------------
\setkomavar{subject}{Anwort auf Schreiben vom 14.07.2014}
%---------------------------------------------------------------------------
\opening{Sehr geehrte Damen und Herren,}

meine gegenwärtige finanzielle Situation erlaubt es mir lediglich, die Forderung in Form einer Ratenzahlung zu begleichen. Ich biete Ihnen an den ausstehenden Betrag Raten von monatlich 10 EUR zu tilgen.
