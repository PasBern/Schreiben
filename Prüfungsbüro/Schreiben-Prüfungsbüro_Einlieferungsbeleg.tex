...
%---------------------------------------------------------------------------
\firsthead{Beleg für fristgerechte Abgabe der Diplomarbeit}
%---------------------------------------------------------------------------
%\firstfoot{Fußzeile}
%---------------------------------------------------------------------------
...
%\setkomavar{yourref} {0-499500029138-0}%%    'Ihr Zeichen...'
...
%---------------------------------------------------------------------------
\begin{letter}{Prüfungsbüro Otto-Suhr--Institut\\Frau Roswitha Beck\\Freie Universität Berlin\\Ihnestraße 21\\14195 Berlin}
%---------------------------------------------------------------------------
% Weitere Optionen
\KOMAoptions{%%
}
%---------------------------------------------------------------------------
\setkomavar{subject}{Übersendung des Einlieferungsbelegs zur Abgabe der Diplomarbeit}
%---------------------------------------------------------------------------
\opening{Sehr geehrte Frau Beck,}

hiermit übersende ich Ihnen den Einlieferungsbeleg für meine Diplomarbeit, um nachweisen zu können, dass ich diese fristgerecht am 11. April 2014 eingereicht habe.
